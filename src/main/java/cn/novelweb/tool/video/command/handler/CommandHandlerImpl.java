...
import cn.novelweb.tool.video.command.assemble.CommandAssemble;
import cn.novelweb.tool.video.command.assemble.CommandAssembleImpl;
import cn.novelweb.tool.video.command.assemble.CommandBuilder;
import cn.novelweb.tool.video.command.task.TaskDao;
import cn.novelweb.tool.video.command.task.TaskDaoImpl;
