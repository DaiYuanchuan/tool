...
public final class CmdConstants {
     ...
     * 客户端关闭连接命令
     */
    public static final byte DFS_PROTO_CMD_QUIT = 82;
    /**
     * 连接状态检查命令
     */
    public static final byte DFS_PROTO_CMD_ACTIVE_TEST = 111;
    /**
     * 服务端正确返回报文状态
     */
    public static final byte DFS_PROTO_CMD_RESP = 100;
