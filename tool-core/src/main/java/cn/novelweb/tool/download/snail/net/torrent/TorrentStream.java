...
import cn.novelweb.tool.download.snail.pojo.bean.TorrentPiece;
import cn.novelweb.tool.download.snail.utils.*;
...
public final class TorrentStream {
	...
	public static TorrentStream newInstance(
		...
		final TorrentStream stream = new TorrentStream(pieceLength, path, size, pos, completed, fileBufferSize, torrentStreamGroup);
		// TODO：{}，使用多行文本
		LOGGER.debug(
