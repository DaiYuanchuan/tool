...
import cn.novelweb.tool.download.torrent.client.announce.*;
import cn.novelweb.tool.download.torrent.client.network.CountLimitConnectionAllower;
import cn.novelweb.tool.download.torrent.client.network.OutgoingConnectionListener;
import cn.novelweb.tool.download.torrent.client.network.StateChannelListener;
import cn.novelweb.tool.download.torrent.client.peer.PeerActivityListener;
import cn.novelweb.tool.download.torrent.client.peer.SharingPeer;
import cn.novelweb.tool.download.torrent.client.storage.FairPieceStorageFactory;
import cn.novelweb.tool.download.torrent.client.storage.FileCollectionStorage;
import cn.novelweb.tool.download.torrent.client.storage.PieceStorage;
import cn.novelweb.tool.download.torrent.client.storage.PieceStorageFactory;
...
import cn.novelweb.tool.download.torrent.common.protocol.PeerMessage;
import cn.novelweb.tool.download.torrent.network.*;
...
import static cn.novelweb.tool.download.torrent.common.protocol.AnnounceRequestMessage.RequestEvent.*;
...
public class CommunicationManager implements AnnounceResponseListener, PeerActivityListener, Context, ConnectionManagerContext {
  ...
  public void start(final InetAddress[] bindAddresses,
    ...
    this.myConnectionManager = new ConnectionManager(
            ...
            mySendBufferSize,
            myReceiveBufferSize);
    this.setSocketConnectionTimeout(Constants.DEFAULT_SOCKET_CONNECTION_TIMEOUT_MILLIS, TimeUnit.MILLISECONDS);
    try {
